...
+(void)showTimePickerViewDeadLine:(NSString *)deadLine withTitle:(NSString*)title CompleteBlock:(void (^)(NSDictionary *))completeBlock{
    
    MyTimePickerView *timePickerView = [self myTimePickerViewWithDeadLine:deadLine];
    if (title) {
        [timePickerView.topLabel setText:title];
    }
