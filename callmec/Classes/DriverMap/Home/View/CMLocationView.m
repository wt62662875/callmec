...
#import "CMLocation.h"
#import "CMLocationControl.h"
#import "CMSearchManager.h"

@interface CMLocationView ()
{
    CMLocationControl *_startControl;
    CMLocationControl *_endControl;
...
- (void)initStartControl
{
    if (!_startControl)
    {
        _startControl = [[CMLocationControl alloc] initWithFrame:self.bounds];
...
- (void)initEndControl
{
    if (!_endControl)
    {
        _endControl = [[CMLocationControl alloc] initWithFrame:self.bounds];
