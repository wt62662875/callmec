...
- (void) initSpeaker
{
    ...
    UIImageView *imageView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"yinxiao"]];
...
//        make.right.equalTo(self).offset(-30);
    ...
    [self.lb_name_v setTextColor:RGBHex(g_black)];
    [self.lb_name_v setFont:[UIFont systemFontOfSize:17]];
    ...
    [_buttonS setOnTintColor:RGBHex(g_blue)];
