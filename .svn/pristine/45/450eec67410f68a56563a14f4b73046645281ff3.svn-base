...
- (void) initExtraView
{
    ...
    [_inputText.layer setBorderColor:RGBHex(g_blue).CGColor];
...
//    [_inputText se];
    ...
    [_commit setTitleColor:RGBHex(g_blue) forState:UIControlStateNormal];
    [_commit.layer setBorderWidth:1];
    [_commit.layer setBorderColor:RGBHex(g_blue).CGColor];
