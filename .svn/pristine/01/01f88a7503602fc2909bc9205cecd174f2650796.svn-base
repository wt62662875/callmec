...
@interface TripFourController()<UITableViewDataSource,UITableViewDelegate,CallBackDelegate,CellTargetDelegate>
...
- (void) cellTarget:(id)sender
{
    if ([sender isKindOfClass:[OrderModel class]]) {
        ...
        {
            WaitingBusController *order_ctrl = [[WaitingBusController alloc] init];
